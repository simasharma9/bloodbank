...
$sql="SELECT * FROM campaign  $limit ";
 ...
 $result=$con->query($sql);
						...
						{
								$list.= "<table class='table table-striped' ><tr>
												<th>#</th>
												<th>Title</th>
												<th>Venue</th>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												...
												$list.= "<td>".$row["venue"]."</td>";
												$list.= "<td>".$row["organised_by"]."</td>";
												$list.= "<td>".$row["campaign_date"]."</td>";
												$list.= "<td>".$row["campaign_time"]."</td>";


												$list.= "<td><a href='admin_del_campaign.php?id=".$row["id"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
