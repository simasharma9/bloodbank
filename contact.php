...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Bank &amp; <br>abc..<br>
					Amarsingh Chowk,<br>
					Pokhara-12<br>
					Kaski Dt.
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 9816642580</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="#" >abc@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">W</abbr>: <a href="index.php">www.abc.org</a></p>
