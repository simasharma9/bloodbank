...
<?php include"top_nav.php";?>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/s22.jpg');"></div>
                <div class="carousel-caption">
      ...
      <div class="row">
        ...
        <div class="row">
			...
			<ul>
				...
				<li>We need hundreds of blood donations every day to treat patients in need across nepal. Which is why there’s always a need for people to give blood.</li>

				<li>Each year we need thousands of new donors, as some donors can no longer give blood.</li>
